...
"""Job Embedding Pipeline: orchestrates chunk creation, deletion of old data, batch embedding generation,
and storage of vector embeddings for semantic job-to-resume matching."""
